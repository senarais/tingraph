 ...
 *
 * The database repeats every limit here as a constraint: the browser holds a
 * key that can write a profile without ever passing through this file.
 */
...
/** The kind of email link a `type` parameter names, or null for anything else. */
